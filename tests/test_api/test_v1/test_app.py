...
class TestAppDocs(unittest.TestCase):
    """Classe pour tester Flask App docs"""
    ...
    def test_all_function_docs(self):
        """... tests pour TOUS les documents pour toutes les fonctions dans le fichier db_storage"""
        all_functions = TestAppDocs.all_funcs
        for function in all_functions:
            self.assertIsNotNone(function[1].__doc__)

    def test_pep8_app(self):
        """... app.py est conforme avec PEP8 Style"""
