#!/usr/bin/python3
"""
Route y  Flask qui renvoie la réponse d’état json
"""
...
def places_per_city(city_id=None):
    """
        place la route pour gérer la méthode http pour les lieux demandés par ville
    """
...
def places_with_id(place_id=None):
    """
        place route pour gérer les méthodes http pour un lieu donné
    """
...
def places_search():
    """
        place route pour gérer la méthode http pour la demande de recherche de lieux
    """
