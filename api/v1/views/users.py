#!/usr/bin/python3
"""
    Route Flask qui renvoie la réponse json
"""
...
def users_no_id(user_id=None):
    """
        route des utilisateurs qui gère les requêtes http sans ID donné
    """
...
def user_with_id(user_id=None):
    """
        route des utilisateurs qui gère les requêtes http avec ID donné
    """
