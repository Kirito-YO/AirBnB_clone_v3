#!/usr/bin/python3
"""
    Route Flask qui retourne json respone
"""
...
def amenities_no_id(amenity_id=None):
    """
        route d’agréments qui gère les requêtes http sans ID donné
    """
...
def amenities_with_id(amenity_id=None):
    """
        route d’agréments qui gère les requêtes http avec ID donné
    """
